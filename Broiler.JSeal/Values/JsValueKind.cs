...
/// CLR <see langword="null"/> â€” not <c>undefined</c> â€” for an index past the end, and 598 argument
...
/// </para>
/// <para>
/// <b><see cref="Function"/> and <see cref="Array"/> are not ECMAScript types</b> â€” both are Object.
...
{
    /// <summary>No value at all â€” an argument that was not supplied. See the remarks on this enum.</summary>
    Missing = 0,
    ...
    /// <summary>An ordinary object â€” anything not covered by <see cref="Function"/> or <see cref="Array"/>.</summary>
    Object = 8,
